...
export class SandboxService {
  getDashboardData() {
    return {
      ...
      recentActivity: [
        { id: 1, user: 'Demo User', action: 'completed task "Hero Section Design"', timestamp: '2 mins ago' },
    ...
    const members = [
      {
        ...
        role: 'Owner',
        joinedAt: '2024-01-15',
        user: { id: 'u1', email: 'demo@example.com', firstName: 'Demo', lastName: 'User' },
      },
      {
        userId: 'u2',
        role: 'Maintainer',
        joinedAt: '2024-02-10',
        user: { id: 'u2', email: 'sarah@example.com', firstName: 'Sarah', lastName: 'Miller' },
      },
      {
        userId: 'u3',
        role: 'Contributor',
        joinedAt: '2024-02-25',
        user: { id: 'u3', email: 'john@example.com', firstName: 'John', lastName: 'Doe' },
      },
    ];

    return { data: members, total: members.length, page, limit };
  }
}
